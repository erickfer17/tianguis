...
<!---fin modal -->
	...
	<div class="category">
			...
			<legend>Filtros</legend>
					<form name='filtrar' method='post' action='mcompras.php?filtro=0' id='srch'>
...
<div style="display: inline-block; position: relative; margin-left: 60%">
			...
			<?php
				...
				$sql=("SELECT pedidos.id,usuario, pedidos.fecha,pedidos.estado from usuario, pedidos where pedidos.idusuario=usuario.id  and pedidos.idusuario='".$_SESSION['id']."' ORDER BY estado DESC, pedidos.fecha ASC");
