...
<!---fin modal -->
			...
			<?php
				...
				$sql=("SELECT usuario.nombre,apellidos,usuario,producto.id , producto.nombre,descripcion,precio,existencias,categoria,activo FROM producto INNER JOIN usuario ON producto.idvendedor = usuario.id ");
